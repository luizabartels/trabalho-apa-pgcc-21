...
# Fit M1
coefficientsM1 = numpy.polyfit(numpy.power(EixoNumeroEntrada, 2),EixoTempoM1,1)
fitM1 = numpy.poly1d(coefficientsM1) 
# Fit M2
coefficientsM2 = numpy.polyfit(numpy.power(EixoNumeroEntrada, 2),EixoTempoM2,1)
fitM2 = numpy.poly1d(coefficientsM2)
# Fit AchaPivo
coefficientsAchaPivo = numpy.polyfit(numpy.power(EixoNumeroEntrada, 2),EixoTempoAchaPivo,1)
fitAchaPivo = numpy.poly1d(coefficientsAchaPivo) 
# Fit Kesimo
coefficientsK = numpy.polyfit(numpy.power(EixoNumeroEntrada, 2),EixoTempoK,1)
fitK = numpy.poly1d(coefficientsK) 


plt.plot(EixoNumeroEntrada,fitM1(numpy.power(EixoNumeroEntrada, 2)), label= 'Randomico')
plt.plot(EixoNumeroEntrada,fitM2(numpy.power(EixoNumeroEntrada, 2)), label = 'Indexado')
plt.plot(EixoNumeroEntrada,fitAchaPivo(numpy.power(EixoNumeroEntrada, 2)), label = 'AchaPivo')
plt.plot(EixoNumeroEntrada,fitK(numpy.power(EixoNumeroEntrada, 2)), label = 'Kesimo')

plt.title("Pior Caso - Lista Decrescente (Ajuste de curva para n^2)")
